...
class Navbar extends Component {
  ...
  render() {
    ...
    const backgroundOpen = this.state.iliteDropdown || this.state.outreachDropdown ? "dropdown__background--open" : "";
      ...
      <nav className="navigation">
        ...
        <ul className="navigation__list">
          ...
          <li onClick={() => this.toggleOutreachDropdown()} >
            <Dropdown title="Outreach" links={outreachLinks} extended={this.state.outreachDropdown} />
          </li>
          <li onClick={() => this.toggleIliteDropdown()} >
            <Dropdown title="About ILITE" links={iliteLinks} extended={this.state.iliteDropdown} />
          </li>
        </ul>
