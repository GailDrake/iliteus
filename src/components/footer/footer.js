...
const Footer = () =>
  <div className="footer">
    <div className="footer__info">
      ...
      <div className="col">
        <h5 className="footer__header">LOCATION</h5><a className="footer__link" href="https://www.google.com/maps/place/ILITE+Robotics/@38.8131815,-77.6879936,11.87z/data=!4m5!3m4!1s0x89b668950b37d0bb:0x94045c6b6225ce3c!8m2!3d38.8453222!4d-77.6301669"><i className="fa fa-map-marker"></i> Map &amp; Directions</a>
