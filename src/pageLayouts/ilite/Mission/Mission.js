    ...
    <Container title="Mission" subtitle="ILITE's mission and vision represented throughout our history" bannerImage="mission__banner">
      <div className='mission'>
        ...
        <div className="mission__image-container">
          <div className='mission__stay'><img className='mission__image mission__stay' src={haymarketday} /></div>
          <div className='mission__remove'><img className='mission__image mission__remove' src={stemexpo1} /></div>
          <div className='mission__remove'><img className='mission__image mission__remove' src={teddy} /></div>
        </div>
        <p className='mission__greybox'> <span className='mission__quotes'><QuoteRight fill='#787878' /></span> To inspire young people to become leaders in science, technology, engineering,
          and mathematics by providing them with hands-on engineering challenges and the mentorship of industry professionals,
                 to build a foundation of both technical and social skills, and to create leaders in technology and engineering.<span className='mission__quotes'><QuoteLeft fill='#787878' /></span>
        </p>
        <h1 className='mission__subheader'>Our Vision:</h1>
        <div className="mission__image-container">
          <div className='mission__remove'><img className='mission__image mission__remove' src={books} /></div>
          <div className='mission__stay'><img className='mission__image mission__stay' src={stemexpo2} /></div>
          <div className='mission__remove'><img className='mission__image mission__remove' src={ussstem} /></div>
        </div>
        <p className='mission__greybox'> <span className='mission__quotes'><QuoteRight fill='#787878' /></span> A community of learning where people, young and old, share a common goal of problem solving through science,
                technology, engineering, and mathematics to improve the world in which we live for all.<span className='mission__quotes'><QuoteLeft fill='#787878' /></span>
        </p>
        <h1 className='mission__subheader'>ILITE-ism:</h1>
        <div className="mission__image-container">
          <div className='mission__remove'><img className='mission__image mission__remove' src={stemexpo3} /></div>
          <div className='mission__stay'><img className='mission__image mission__stay' src={gather} /></div>
          <div className='mission__remove'><img className='mission__image mission__remove' src={experiment} /></div>
        </div>
        <p className='mission__greybox'>Outreach is an effort which requires a diverse plan of attack to reach the greatest number of people,
          all of whom come from different backgrounds. In pursuit of this, ILITE follows a core value it calls "ILITE-ism".
          <br /> <br />
          <span className='mission__quotes'><QuoteRight fill='#787878' /></span>ILITE-ism is the belief that everyone,
          regardless of background or profession, can be an advocate for technology and engineering. <span className='mission__quotes'><QuoteLeft fill='#787878' /></span>
        </p>
        <h1 className='mission__header'>Team History</h1>
        <p className='mission__text'></p>
        <div className="mission__image-container">
          <div className='mission__remove'><img className='mission__image mission__remove' src={trophy} /></div>
          <div className='mission__remove'><img className='mission__image mission__remove' src={pits} /></div>
          <div className='mission__stay'><img className='mission__image mission__stay' src={history} /></div>
        </div>
        <p className='mission__text'>ILITE Robotics was founded in 2006 in Battlefield High School located in Haymarket, Virginia. We started out as a Rookie-All Star Team have continued to strive for excellence in competing at various levels of FIRST and achieving high level awards at the district and championship level. These include, but are not limited to, Imagery, Engineering Inspiration, Chairman’s, and Finalist or Winner awards. Our achievement runs to the International level with a Chairman’s finalist award in 2017. In 2018, we achieved a Triple Crown win at the Chesapeake District Championship. ILITE has also had the honor of a Woodie Flowers award winner and finalist as mentors and coaches on the team.</p>
