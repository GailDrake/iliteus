...
const Competition = () => {
  return (
    <Container
      division="frc"
      title="Competitions"
      subtitle="See all of our competitions from throughout our history"
      id="top"
    >
        ...
        <Tabs>
            ...
            <div className="competition__event" id="tab13">
              ...
              <div className="competition__event-container">
                <div className="competition__awards">
                  ...
                  <ul>
                    <li>
                      FIRST World Championship: Woodie Flowers Award(Gail Drake)
                    </li>
                    <li>
                    ...
                    <li>
                      CHS Southern Maryland District: Excellence in Engineering
                      Award{" "}
                    </li>
                  </ul>
                </div>
                <div className="competition__attended">
                  <h3 className="competition__event-subheader">
              ...
              <div className="competition__event-container">
                <div className="competition__awards">
                  ...
                  <ul>
                    ...
                    <li>
                      CHS District Championship: District Championship Finalist
                    </li>
                    <li>CHS Greater DC District: District Chairman's Award</li>
                    <li>CHS Greater DC District: District Event Winner</li>
                    <li>
            ...
            <div className="competition__event" id="tab11">
              ...
              <div className="competition__event-container">
                <div className="competition__awards">
                  ...
                  <ul>
                    <li>
                      FIRST World Championship Curie Division: Industrial Design
                      Award
                    </li>
                    <li>
                      CHS District Championship: Regional Chairman's Award
              ...
              <div className="competition__event-container">
                <div className="competition__awards">
                  ...
                  <ul>
                    ...
                    <li>
                      Greater DC Regional: FIRST Dean’s List Finalist Award (Amr
                      Metwally)
                    </li>
          ...
          <Tab name="2014">
            <div className="competition__event" id="tab9">
              <h1 className="competition__event-header">
                2014 - Aerial Assist
              </h1>
              <iframe
                width="100%"
            ...
            <div className="competition__event" id="tab2">
              ...
              <div className="competition__event-container">
                <div className="competition__awards">
                  ...
                  <ul>
                    <li>
                      NASA/VCU Regional: Regional Engineering Inspiration Award
                    </li>
