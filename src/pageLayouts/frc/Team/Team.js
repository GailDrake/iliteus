    ...
    <Container title="Banner" subtitle="This is a banner for the team page.">
      <div className="team">
        <Tabs>
          ...
          <Tab name="Build">
            <h1>Build</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight />To be able to create an efficient and robust robot that represents the whole of our abilities and capabilities as a subteam and serves as a base for other subteams’ work. In the process, we would like to maintain a priority for safety, control, and an appreciation for quality design.<QuoteLeft /></div>
          ...
          <Tab name="Electronics">
            <h1>Electronics</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight />To be able to create an efficient electronics board that represents our electronic capabilities. In the process of doing this we want to make a board that is safe, neat, and working.<QuoteLeft /></div>
          ...
          <Tab name="Programming">
            <h1>Programming</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight />To create practical and efficient code that allows us to utilize all of the physical components of the robot through the utilization of mathematics and advanced computer science principles.<QuoteLeft /></div>
          ...
          <Tab name="Sponsorship">
            <h1>Sponsorship</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight />To raise funds and acquire resources by marketing and campaigning for the team. In the process, we contact potential sponsors and maintain current sponsors that support the team.<QuoteLeft /></div>
          ...
          <Tab name="Outreach">
            <h1>Outreach</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight />To inspire people, young and old, to become leaders in science, technology, engineering, and mathematics by providing them with the proper environment, social encouragement to pursue STEM, and necessary resources and mentoring to continue learning and working in STEM in and out of school environments.<QuoteLeft /></div>
          ...
          <Tab name="Website">
            <h1>Website</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight />To inspire young and old minds alike to pursue and maintain interest in FIRST and STEM through the presentation of our website and distribution of other web media.<QuoteLeft /></div>
            <img src={require('../../../assets/images/frc/members/Programming/Programming+Web.jpg')} className="team__img" />
          ...
          <Tab name="Graphics">
            <h1>Graphics</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight />To communicate a specific message to a specific audience through visual stimulation, inspire creativity and a sense of self-expression in others, and to express professionalism through systematic, organized designs.<QuoteLeft /></div>
