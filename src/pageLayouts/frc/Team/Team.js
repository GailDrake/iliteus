    ...
    <Container division="frc" title="Team" subtitle="ILITE has a team structure that emphasises student leadership and mentorship.">
      <div className="team">
        <Tabs>
          ...
          <Tab name="Build">
            <h1>Build</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight fill='grey' />To be able to create an efficient and robust robot that represents the whole of our abilities and capabilities as a subteam and serves as a base for other subteams’ work. In the process, we would like to maintain a priority for safety, control, and an appreciation for quality design.<QuoteLeft fill='grey' /></div>
            <img src={require('../../../assets/images/frc/members/Build/Build.jpg')} className="team__img" />
            ...
            <div className="team__greybox">
              <h2>Goals</h2>
              <ol>
                <li>To develop a seasonal drivetrain as the foundation of the team’s robot</li>
                <li>To design complex components such as arms, claws, and shooters that attach to the drivetrain to allow the robot to successfully be either an offensive, defensive, or equally-balanced robot on the field</li>
                <li>To prototype and experiment before settling on a final product later executed with precise manufacturing techniques</li>
                <li>To model the robot and design process in OpenSCAD and Inventor to ensure team documentation and to create engineering drawings for manufacturing</li>
              </ol>
            </div>
            <div className="team__greybox">
              <h2>Awards</h2>
              <ul>
                <li>2018 Oxon Hill District Event: Excellence in Engineering Award</li>
                <li>2016 FRC World Championship District Event: Industrial Design Award</li>
                <li>2016 Hampton Roads District Event: Industrial Design Award</li>
          ...
          <Tab name="Electronics">
            <h1>Electronics</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight fill='grey' />To be able to create an efficient electronics board that represents our electronic capabilities. In the process of doing this we want to make a board that is safe, neat, and working.<QuoteLeft fill='grey' /></div>
            <img src={require('../../../assets/images/frc/members/Electronics/Electronics.jpg')} className="team__img" />
            <p>The Electronics subteam’s main task is to efficiently route and connect the necessary components needed for the robot to function. These include talons, roboRIO, power distribution panel (PDP), and the voltage regulator module (VRM). Other components called sensors each serve a unique function to the robot. Each year, our robot uses a multitude of sensors to help the robot record data to allow it to perform as expected on the field. We use multiple different types of wires that vary in gauge size to connect all of these components. While doing this, we learn many useful concepts such as space management and labeling. Throughout the years, we have used these major concepts by routing the wires together onto the electronics board in the most efficient way for us to track the flow of electricity. This year, we were able to use 3-D printing to assist us with customized casings for not only our ports but our components, which in turn made our electronics board much neater and safer. Along with ensuring that the robot has all the appropriate sensors, talons, and other components, the Electronics Team is responsible for creating a functional pneumatic setup. In this setup, our robot works with a compressor that generates air which flows through pneumatic tubing through multiple regulators that will eventually be used to activate the moving parts of the robot. Lastly, our Electronics subteam must be able to effectively explain the purpose and concepts of each component to other members of our robotics team, such as programming to allow their code to work, as well as interested members of the community and potential future members.</p>
            <div className="team__greybox">
              <h2>Goals</h2>
              <ol>
                <li>Efficiently route all the necessary components of the robot to allow it to run as expected. In doing this we must master the art of space management, color coding, and many other tasks to make our electronics board neat and logical.</li>
                <li>Explain how each sensor collects data and runs to programmers to help them write the code required for each sensor.</li>
                <li>Make a neat and safe electronics board that is appropriately labeled and protected to ensure that no wires or components can burn and create a dangerous environment.</li>
                <li>To create a pneumatic system that is able to generate air and flow through tubing to activate the targeted piston.</li>
          ...
          <Tab name="Programming">
            <h1>Programming</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight fill='grey' />To create practical and efficient code that allows us to utilize all of the physical components of the robot through the utilization of mathematics and advanced computer science principles.<QuoteLeft fill='grey' /></div>
            <img src={require('../../../assets/images/frc/members/Programming/Programming+Web.jpg')} className="team__img" />
            <p>The Programming Team is primarily put in charge of developing and writing code for the robot. Most of our time is spent focusing on developing necessary algorithms and testing these algorithms to allow smooth operation of the robot both autonomously and in driver operation mode. This includes, but is not limited to, writing code for object tracking through the use of a camera mounted on the robot, reading and interpreting data from both analog and digital inputs, and outputting the proper data to the robot for actions independent of human interaction and to provide clean and consistent movements that the drivers can always rely on. Over the years, ILITE’s robot code has garnered respect and acknowledgement for the successful code structure. All in all, the Programming Team has a long history of pushing the bounds of what a robot can achieve.</p>
            <div className="team__greybox">
              <h2>Goals</h2>
              <ol>
                <li>To create code that is able to utilize physical modules on the robot that take advantage of game pieces and is able to complete game objectives consistently.</li>
                <li>To establish a reusable code structure from year to year.</li>
                <li>To create understandable code that is easily accessible for newer members.</li>
                <li>To create good documentation that outlines our code structure and is easily understood by non-programmers.</li>
              </ol>
            </div>
            <div className="team__greybox">
              <h2>Awards</h2>
          ...
          <Tab name="Sponsorship">
            <h1>Sponsorship</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight fill='grey' />To raise funds and acquire resources by marketing and campaigning for the team. In the process, we contact potential sponsors and maintain current sponsors that support the team.<QuoteLeft fill='grey' /></div>
            <img src={require('../../../assets/images/frc/members/Sponsorship/Sponsorship.jpg')} className="team__img" />
          ...
          <Tab name="Outreach">
            <h1>Outreach</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight fill='grey' />To inspire people, young and old, to become leaders in science, technology, engineering, and mathematics by providing them with the proper environment, social encouragement to pursue STEM, and necessary resources and mentoring to continue learning and working in STEM in and out of school environments.<QuoteLeft fill='grey' /></div>
            <img src={require('../../../assets/images/frc/members/Outreach/Outreach.jpg')} className="team__img" />
          ...
          <Tab name="Scouting">
            <h1>Scouting</h1>
            <div className="team__greybox"><h2>Subteam Specific Mission Statement</h2><QuoteRight fill='grey' />To efficiently and accurately gather data on various aspects of other teams and effectively present the data to the team to assist in the decision making process for alliance selection.<QuoteLeft fill='grey' /></div>
            ...
            <div className="team__greybox">
              <h2>Goals</h2>
              <ol>
                <li>To efficiently and accurately gather data on other teams.</li>
                <li>To effectively present gathered data to the team for alliance selection.</li>
