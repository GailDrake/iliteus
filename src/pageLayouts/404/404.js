        ...
        <LayoutWrapper>
            ...
            >
                <div className="page-not-found"> 
                    <h1 className="page-not-found_hr">Please refer to the top right of the page to relocate to the correct page</h1>
                    <p className="page-not-found_p">
                        Here are some other links that may be helpful
                        <ul>
                                <Button
                                    link="https://www.firstinspires.org/"
                                    division="frc"
                                    className="page-not-found_button"
                                >
                                    First Inspires
                                </Button>
                                <Button
